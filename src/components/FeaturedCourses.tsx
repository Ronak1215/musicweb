    ...
    <div className="py-20 bg-gray-900">
      <div>
        <div className="text-center">
          ...
          <p className="mt-2 text-3xl font-extrabold tracking-tight text-white sm:text-6xl">
            Learn With the Best
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {featuredCourse.map((course: Course) => (
            <div key={course.id} className="flex justify-center">
              <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-xl">
                {" "}
                <div className="p-4 sm:p-10 flex flex-col items-center text-center flex-grow">
                  <p className="text-2xl sm:text-4xl text-black mt- mb-2 dark:text-neutral-200">
                    {course.title}
                  </p>
                  <p className="md:text-2xl px-10 text-neutral-600 dark:text-neutral-400 flex-grow mt-4 mb-4">
                    {course.description}
                  </p>
