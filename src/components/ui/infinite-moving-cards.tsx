        ...
        {items.map((item, idx) => (
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className=" relative z-20 text-sm md:text-xl leading-[1.6] text-gray-100 font-normal">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className=" text-sm md:text-xl leading-[1.6] text-gray-400 font-normal">
                    {item.name}
                  </span>
                  <span className=" text-sm md:text-xl leading-[1.6] text-gray-400 font-normal">
                    {item.title}
